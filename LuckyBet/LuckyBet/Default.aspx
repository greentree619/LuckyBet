   ...
   <title>水果老虎机</title>
	...
	<script>              
        ...
        wLaoHuJi.prototype.init = function () {
            ...
            digit7_total(txt_total_7dgt, _total.toFixed(2), 12);  /// usercoin잔액 7segment현시 (초기값 세션에서 읽은값)
